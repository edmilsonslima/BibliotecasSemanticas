# -*- coding: utf-8 -*-
"""Terminologiafinal100125.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vXp1gFkGvUH4U029WkyPiXl79vrTi6b7
"""
...
# Função para corrigir codificação
def corrigir_codificacao(texto):
    try:
        # Tenta decodificar usando 'latin1' e reencoda em 'utf-8'
        texto_corrigido = texto.encode('latin1', errors='ignore').decode('utf-8', errors='replace')
...
for link in links_da_palavra:
    ...
    # Corrigir codificação e processar o texto
    texto_corrigido = corrigir_codificacao(texto)

    # Formatação do texto
    texto_corrigido = " ".join(texto_corrigido.split())
    texto_formatado = textwrap.fill(texto_corrigido, width=80)
